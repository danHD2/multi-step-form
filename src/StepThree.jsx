        ...
        {addOnData.map((item) => {
          ...
          return (
            <div
              ...
              className={`flex hover:border-purplishBlue transition-all border items-center select-none cursor-pointer justify-between flex-row mb-4 rounded-lg px-5 py-4 ${
                item.state
            ...
            >
              <div className="flex">
                <input
                  ...
                  checked={item.state}
                  readOnly
                  className="mr-5 w-4 rounded-lg cursor-pointer accent-purplishBlue"
                />
              ...
              {!everything.monthly ? (
                <p className="text-purplishBlue">{item.monthlyPrice}</p>
              ) : (
                <p className="text-purplishBlue">{item.yearlyPrice}</p>
              )}
            </div>
          );
        })}
